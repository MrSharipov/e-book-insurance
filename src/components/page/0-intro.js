...
export const TopicZero = () => {
  return (
    <div className="page">
      ...
      />
      <p>
        Respublikamiz sug’urta bozorini yanada rivojlantirish, aholini sifatli
        moliyaviy xizmatlar bilan qamrab olish ko’lamini kengaytirish, sug’urta
        ...
        biznesida sug‘urta vositachilarning tutgan o‘rni va ular bilan o‘zaro
        munosabatlarni tashkil etilishi, sug‘urta biznesida moliyaviy faoliyatni
        byudjetlashtirish, sug‘urta tashkilotlarida moliyaviy natijaning
        shakllanishi, aktuariylar boshqarmasi va uning faoliyatini tashkil
        etish, sug‘urta zahiralari: sug‘urta zahiralari va uning umumiy
        xarakteristikasi, sug‘urta biznesini soliqqa tortish turlari va uning
        tartibi, sug‘urta tashkilotining aktuar hisoboti va uning auditorlik
        tekshiruvini hamda sug‘urta tashkilotining bo‘limlar faoliyatini tashkil
        etish bo’yicha nazariy va amaliy jihatlari o'z aksini topgan.
      </p>
    </div>
  );
};
